...
export const BOTANY_PARAM_FIELD_SCHEMA = {
  ...
  simulationYears: { type: 'integer', min: 1, max: 200 },
  ticksPerYear: { type: 'integer', min: 1, max: 120 },
  ...
  terrainCenterX: { type: 'number', min: -10000, max: 10000 },
  terrainCenterZ: { type: 'number', min: -10000, max: 10000 },
  terrainInnerRadius: { type: 'number', min: 1, max: 5000 },
  terrainSmallRidgeRadius: { type: 'number', min: 1, max: 5000 },
  terrainLargeRidgeRadius: { type: 'number', min: 1, max: 5000 },
  terrainOuterRimRadius: { type: 'number', min: 1, max: 5000 },
  terrainInnerDepth: { type: 'number', min: -200, max: 200 },
  terrainSmallRidgeHeight: { type: 'number', min: -200, max: 200 },
  terrainLargeRidgeHeight: { type: 'number', min: -200, max: 200 },
  terrainOuterRimHeight: { type: 'number', min: -200, max: 200 },
  terrainNoiseAmplitude: { type: 'number', min: 0, max: 100 },
  terrainNoiseFrequency: { type: 'number', min: 0.0001, max: 1 },
  terrainMicroNoiseAmplitude: { type: 'number', min: 0, max: 50 },
  terrainMicroNoiseFrequency: { type: 'number', min: 0.0001, max: 1 },
  terrainSlopeSharpening: { type: 'number', min: 0, max: 4 },
  terrainBasinFlattening: { type: 'number', min: 0, max: 2 },
